...
$(document).ready(function() {
    ...
    $(".booking-form").submit(function(e) {
        ...
        var dataString = "firstname=" + firstname.val() + "&lastname=" + lastname.val() + "&email=" + email.val() + "&phone=" + phone.val() + "&subject=" + subject.val() + "&staff=" + staff.val() + "&date=" + date.val();
        $(".loading").fadeIn("slow").html("Loading...");
        $.ajax({
            type: "POST",
            data: dataString,
            url: "php/bookingForm.html",
            cache: false,
            success: function (d) {
