					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-5 col-lg-6">
							<div class="booking-1-img">
								<img class="img-fluid" src="images/BookingImage---1000x850.jpg" alt="booking-image">
							</div>
						</div>
								...
								<div class="form-holder">
									...
									<form name="bookinkform" class="row booking-form" method="POST">
						                ...
						                <div class="col-md-12 mt-10 text-end">  
						                	<button type="submit" class="btn rose--btn tra-black--hover submit">Book Now</button> 
						                </div>
